 ...
 */
package com.mengyan.springsecurity.utils;
...
public class MengYanCodeUtil {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/springsecurity/src/main/java");
        gc.setAuthor("Guoxb");
        gc.setOpen(false);
        ...
        pc.setParent("mengyan.springsecurity.modular");
        pc.setEntity("entity");
        pc.setMapper("mapper");
